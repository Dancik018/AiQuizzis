...
A same-input real OpenAI comparison (20 technical open questions, option generation) measured 32.4 s provider time / 3,091 output tokens before and 19.8 s / 2,194 output tokens after compact output. This is one controlled sample, not a latency guarantee for all subjects or account limits. Full document benchmarks are reported separately.
